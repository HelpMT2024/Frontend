        ...
        child: Column(
          ...
          children: [
            SettingsItem(
              ...
              icon: Icons.password,
              onTap: () => widget.viewModel.resetPassword(context),
            ),
            const SizedBox(height: 8),
            SettingsItem(
              title: l10n?.language ?? '',
              icon: Icons.language,
              onTap: () => widget.viewModel.changeLanguage(context),
            ),
            const SizedBox(height: 8),
            SettingsItem(
              title: l10n?.subscription ?? '',
              icon: Icons.credit_card,
              onTap: () => widget.viewModel.subscription(context),
            ),
            const SizedBox(height: 8),
            SettingsItem(
            ...
            SettingsItem(
              ...
              icon: Icons.delete,
              hasArrow: false,
              onTap: () => widget.viewModel.deleteProfile(context),
            ),
            const SizedBox(height: 8),
            SettingsItem(
              title: l10n?.logout ?? '',
              icon: Icons.logout,
              hasArrow: false,
              onTap: () => widget.viewModel.logout(context),
            ),
          ],
        ),
      ),
